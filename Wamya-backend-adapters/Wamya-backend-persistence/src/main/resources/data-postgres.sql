...
INSERT INTO LOCALIZED_ENGINE_TYPE(id, locale, name, description) VALUES(7,'fr_FR', 'V�hicule L3H3', 'Examples de V�hicule L1H1: Renault Master L3H3, Peugeot Boxer L3H3, Fiat Ducato L3H3') ON CONFLICT DO NOTHING;
...
INSERT INTO LOCALIZED_ENGINE_TYPE(id, locale, name, description) VALUES(8,'fr_FR', 'V�hicule L4H3', 'Examples de V�hicule L4H3: Renault Master L4H3, Peugeot Boxer L4H3, Fiat Ducato L3H3') ON CONFLICT DO NOTHING;
...
INSERT INTO LOCALIZED_ENGINE_TYPE(id, locale, name, description) VALUES(13,'fr_FR', 'Camion � benne basculante', 'Examples de camion � benne basculante: Iveco Stralis, Renault Kerax, Mercedes Arocs') ON CONFLICT DO NOTHING;
