...
@Generated
@Entity
@Table(name = "localized_journey_request_status")
@NoArgsConstructor
@AllArgsConstructor
@Builder
@Cacheable
public class LocalizedJourneyRequestStatusJpaEntity {
	@EmbeddedId
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LocalizedJourneyRequestStatusJpaEntity other = (LocalizedJourneyRequestStatusJpaEntity) obj;
		if (localizedId == null) {
			return false;
	...
	public String toString() {
		return "LocalizedJourneyRequestStatusEntity [localizedId=" + localizedId + ", status=" + status + ", value="
				+ value + "]";
	}
