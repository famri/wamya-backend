...
@Generated
@Entity
@Table(name = "localized_delegation")
@NoArgsConstructor
@AllArgsConstructor
@Builder
@Cacheable
public class LocalizedDelegationJpaEntity {
	@EmbeddedId
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LocalizedDelegationJpaEntity other = (LocalizedDelegationJpaEntity) obj;
		if (localizedId == null) {
			return false;
	...
	public String toString() {
		return "LocalizedDelegationJpaEntity [localizedId=" + localizedId + ", name=" + name + ", delegation="
				+ delegation + "]";
	}
