...
import static com.excentria_it.wamya.test.data.common.DepartmentJpaTestData.defaultExistentArrivalDepartmentJpaEntity;
import static com.excentria_it.wamya.test.data.common.DepartmentJpaTestData.defaultExistentDepartureDepartmentJpaEntity;
...
public class JourneyRequestsPersistenceAdapterTests {
    ...
    void givenExistentDeparturePlaceAndExistentArrivalPlace_WhenCreateJourneyRequest_ThenSaveJourneyRequestJpaEntity() {
        ...
        given(clientRepository.findClientBySubject(TestConstants.DEFAULT_EMAIL)).willReturn(Optional.of(clientJpaEntity));
    ...
    @Test
    void givenNonExistentDeparturePlaceAndNonExistentArrivalPlace_WhenCreateJourneyRequest_ThenCreateDepartureAndArrivalPlacesAndSaveJourneyRequestJpaEntity() {
    ...
    @Test
    void givenEmptyDepartureDepartment_WhenCreateJourneyRequest_ThenThrowIllegalArgumentException() {
        // given
        JourneyRequestInputOutput journeyRequest = defaultJourneyRequestInputOutputBuilder().build();
        ...
        assertThrows(IllegalArgumentException.class, () -> journeyRequestsPersistenceAdapter
                .createJourneyRequest(journeyRequest, TestConstants.DEFAULT_EMAIL, "en_US"));

    }

    @Test
    void givenEmptyArrivalDepartment_WhenCreateJourneyRequest_ThenThrowIllegalArgumentException() {
        // given
        JourneyRequestInputOutput journeyRequest = defaultJourneyRequestInputOutputBuilder().build();
    ...
    @Test
    void givenEmptyEngineType_WhenCreateJourneyRequest_ThenThrowIllegalArgumentException() {
        // given
        JourneyRequestInputOutput journeyRequest = defaultJourneyRequestInputOutputBuilder().build();
    ...
    @Test
    void givenClientNotFoundBySubject_WhenCreateJourneyRequest_ThenThrowIllegalArgumentException() {
        // given
        JourneyRequestInputOutput journeyRequest = defaultJourneyRequestInputOutputBuilder().build();
        DepartmentJpaEntity departureDep = defaultExistentDepartureDepartmentJpaEntity();
        DepartmentJpaEntity arrivalDep = defaultExistentArrivalDepartmentJpaEntity();
        ...
        given(clientRepository.findClientBySubject(any(String.class))).willReturn(Optional.empty());
    ...
    @Test
    void givenNotNullJourneyRequestsPageAndClientEmail_WhenLoadClientJourneyRequests_ThenReturnClientJourneyRequests() {
    ...
    void testLoadJourneyRequestByIdAndClientEmail() {
        ...
        Optional<ClientJourneyRequestDtoOutput> result = journeyRequestsPersistenceAdapter
                .loadJourneyRequestByIdAndClientSubject(1L, TestConstants.DEFAULT_EMAIL, "fr_FR");
    ...
    @Test
    void testLoadNonExistentJourneyRequestById() {
    ...
    @Test
    void testExistentJourneyRequestByIdAndClientEmailSubject() {
        // given
        given(journeyRequestRepository.existsAndNotExpiredByIdAndClient_Email(any(Long.class), any(String.class)))
                .willReturn(true);
        // when
        boolean result = journeyRequestsPersistenceAdapter.isExistentAndNotExpiredJourneyRequestByIdAndClientSubject(1L,
    ...
    @Test
    void testExistentJourneyRequestByIdAndClientIccAndMobileNumberSubject() {
        // given
        given(journeyRequestRepository.existsAndNotExpiredByIdAndClient_Icc_ValueAndClient_MobileNumber(any(Long.class), any(String.class), any(String.class)))
                .willReturn(true);
        // when
        boolean result = journeyRequestsPersistenceAdapter.isExistentAndNotExpiredJourneyRequestByIdAndClientSubject(1L,
    ...
    @Test
    void testExistentJourneyRequestByIdAndClientOauthIdSubject() {
        // given
        given(journeyRequestRepository.existsAndNotExpiredByIdAndClient_OauthId(any(Long.class), any(String.class)))
                .willReturn(true);
        // when
        boolean result = journeyRequestsPersistenceAdapter.isExistentAndNotExpiredJourneyRequestByIdAndClientSubject(1L,
                "some-client-oauth-id");
        // then
        assertTrue(result);
    }

    @Test
    void testNonExistentJourneyRequestByIdAndClientEmailSubject() {
        // given
        given(journeyRequestRepository.existsAndNotExpiredByIdAndClient_Email(any(Long.class), any(String.class)))
                .willReturn(false);
        // when
    ...
    @Test
    void testNonExistentJourneyRequestByIdAndClientIccAndMobileNumberSubject() {
        // given
        given(journeyRequestRepository.existsAndNotExpiredByIdAndClient_Icc_ValueAndClient_MobileNumber(any(Long.class), any(String.class), any(String.class)))
                .willReturn(false);
        // when
    ...
    @Test
    void testNonExistentJourneyRequestByIdAndClientOauthIdSubject() {
        // given
        given(journeyRequestRepository.existsAndNotExpiredByIdAndClient_OauthId(any(Long.class), any(String.class)))
                .willReturn(false);
        // when
