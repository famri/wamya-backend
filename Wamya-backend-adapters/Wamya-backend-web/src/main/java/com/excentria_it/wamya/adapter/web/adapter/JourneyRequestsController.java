...
public class JourneyRequestsController {
	...
	@GetMapping(path = "/journey-requests")
	public JourneyRequestsSearchResult search(@RequestParam(name = "departure") String departurePlaceRegionId,
		...
		return searchJourneyRequestsUseCase.searchJourneyRequests(command);
